...
<div class="profile-cover" >
    <div class="coverImage">
        <img id="cover" src="{{asset('image/chelsea.jpg')}}" alt="">
        <div class="upload_cover">
            <a id="upload_cover">
                <i class="fas fa-camera fa-1.5x"></i>
                    <span>Cập nhật ảnh bìa</span>
                    <input type="file" name="" id="input_upload_cover" onchange="read_cover(this);">
    ...
    <div class="profile-card js-profile-card">
      ...
      <img src="{{asset('image/icon_thuong.jpg')}}"  id="avatar" alt="profile card">
      <div class="upload_avatar" onclick="upload_avatar()">
      ...
      <input type="file" name="" id="input_upload_avatar"  onchange="read_avatar(this);" >

      <div class="profile-card__cnt js-profile-cnt">
        <div class="profile-card__name">Nguyễn Văn A</div>
        <div class="profile-card__txt">Admin from <strong>Fast Track SE</strong></div>
        ...
        <div class="profile-card-inf">
          <div class="profile-card-inf__item">
            <div class="profile-card-inf__title"><span class="count">20</span></div>
            <div class="profile-card-inf__txt">Photos</div>
          </div>

          <div class="profile-card-inf__item">
            <div class="profile-card-inf__title"><span class="count">10</span></div>
            <div class="profile-card-inf__txt">Posts</div>
          </div>

          <div class="profile-card-inf__item">
            <div class="profile-card-inf__title"><span class="count">200</span></div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" class="form-control" readonly placeholder=" *" value="abc@gmail.com"/>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Phone Number *" readonly    value=" 0123465678"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Your Password *" readonly value=" 22/06/2001"/>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Confirm Password *" readonly value=" 137 Đỗ Đăng Tuyển, Đà Nẵng"/>
                    </div>
                </div>
            </div>
        <div class="profile-card-social">
          <a href="https://www.facebook.com/nhatvuong2206" class="profile-card-social__item facebook" target="_blank">
...
function upload_avatar(){
            $("#input_upload_avatar").click();
        }
             function read_avatar(input) {
